...
class SegmentationMetric(object):
    ...
    def classPixelAccuracy(self):
        ...
        return classAcc  # 返回的是一个列表值，如：[0.90, 0.80, 0.96]，表示类别1 2 3各类别的预测精确率
    ...
    def classPixelRecall(self):
        ...
        return classRecall  # 返回的是一个列表值，如：[0.90, 0.80, 0.96]，表示类别1 2 3各类别的预测召回率
    ...
    def meanPixelRecall(self):
        ...
        return meanRecall  # 返回单个值，如：np.nanmean([0.90, 0.80, 0.96, nan, nan]) = (0.90 + 0.80 + 0.96） / 3 =  0.89
...
if __name__ == '__main__':
    imgPredict = np.array([0, 0, 0, 1, 2, 2])  # 可直接换成预测图片
