...
def main():
    ...
    data_transforms = {
        'train': transforms.Compose([
            ...
            # transforms.Resize((64,64)),  # 随机长宽比裁剪  img_size 输出大小 scale 裁剪的倍数范围
